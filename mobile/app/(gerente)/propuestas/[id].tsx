...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 12, fontWeight: '700', color: '#6B7280', letterSpacing: 1, marginBottom: 10 },
  ...
  vehicleText: { fontSize: 14, color: '#6B7280', flex: 1 },
  ...
  detailRow: { fontSize: 14, color: '#6B7280' },
